        # Fragility Atlas: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/fragility-atlas.git

        ## Objective

        Fragility Atlas is a BMJ multiverse analysis of fragility across clinical trials, mapping the distribution of statistical fragility indices across therapeutic areas.
        ...
        - Code: https://github.com/mahmood726-cyber/fragility-atlas.git
        - Dashboard: https://mahmood726-cyber.github.io/fragility-atlas/
